...
static dd4hep::Ref_t create_element(dd4hep::Detector& theDetector, xml_h e, dd4hep::SensitiveDetector sens) {
  ...
  for (xml_coll_t c(x_det, _U(layer)); c; ++c) {
    ...
    std::cout << "SIT_Simple_Pixel: Layer:" << layer_id << "\t half length = " << layer_geom.half_z
    ...
    dd4hep::rec::VolPlane surf(sitSenLogical, dd4hep::rec::SurfaceType(dd4hep::rec::SurfaceType::Sensitive),
