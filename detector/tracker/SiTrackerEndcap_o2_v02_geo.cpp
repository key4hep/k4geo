  ...
  for(xml_coll_t li(x_det,_U(layer)); li; ++li)  {
    ...
    for(xml_coll_t ri(x_layer,_U(ring)); ri; ++ri)  {
      ...
      for(int k=0; k<nmodules; ++k) {
        ...
        pv.addPhysVolID("barrel",1).addPhysVolID("side",0).addPhysVolID("layer", l_id).addPhysVolID("module",mod_num);
        ...
        if ( reflect ) {
          ...
          pv.addPhysVolID("barrel",2).addPhysVolID("side",1).addPhysVolID("layer",l_id).addPhysVolID("module",mod_num);
