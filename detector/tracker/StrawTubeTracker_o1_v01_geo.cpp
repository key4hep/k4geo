...
static dd4hep::Ref_t create_detector(dd4hep::Detector &theDetector,
  ...
  for (xml_coll_t c(x_det, _U(layer)); c; ++c, ++MLNum) {    
    ...
    strawAssert(MLThickness > 0 || MLLayers > 0,
		"ERROR: Each <layer> in straw tube tracker must have either\n"
    ...
    strawAssert(MLThickness >= minThickness,
		"ERROR: The specified thickness for a multilayer is less than the\n"
    ...
    strawAssert(MLphiRepeat <= maxRepeat,
		"ERROR: The specified number of tubes in the phi direction is greater"
    ...
    dd4hep::Tube   MLTube = dd4hep::Tube  (MLInnerRadius,
