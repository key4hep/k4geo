...
public:
  ...
  void setZMinus_FirstInterrail_PE_Thickness(double PE_Thickness_ZMF) {
    ZMinus_FirstInterrail_PE_Thickness = PE_Thickness_ZMF;
  };
  void setZMinus_FirstInterrail_Cu_Thicknesst(double Cu_Thickness_ZMF) {
    ZMinus_FirstInterrail_Cu_Thickness = Cu_Thickness_ZMF;
  };

  void setZPlus_FirstInterrail_PE_Thickness(double PE_Thickness_ZPF) {
    ZPlus_FirstInterrail_PE_Thickness = PE_Thickness_ZPF;
  };
  void setZPlus_FirstInterrail_Cu_Thickness(double Cu_Thickness_ZPF) {
    ZPlus_FirstInterrail_Cu_Thickness = Cu_Thickness_ZPF;
  };
...
public:
  ...
  void setSit_cables_cylinder_thickness(double cables_cylinder_thickness) {
    Sit_cables_cylinder_thickness = cables_cylinder_thickness;
  };
  ...
  void setSServices_FTD7_cables_thickness(double cable_thickness) {
    SServices_FTD7_cables_thickness = cable_thickness;
  };
...
public:
  ...
  //-Z thicknesses
  void setZMinus_StainlessSteel_Thickness(double ZMinus_StainlessSteel) {
    ZMinus_StainlessSteel_Thickness = ZMinus_StainlessSteel;
  };
  ...
  //+Z thicknesses
  void setZPlus_StainlessSteel_Thickness(double ZPlus_StainlessSteel) {
    ZPlus_StainlessSteel_Thickness = ZPlus_StainlessSteel;
  };
  ...
  void setHcal_steel_cassette_thickness(double cassette_thickness) {
    Hcal_steel_cassette_thickness = cassette_thickness;
  };
  void setHcalServices_outer_FR4_thickness(double PCB_thickness) { HcalServices_outer_FR4_thickness = PCB_thickness; };
  void setHcalServices_outer_Cu_thickness(double copper_thickness) {
    HcalServices_outer_Cu_thickness = copper_thickness;
  };
  ...
  bool FillHcalServicesModuleWithInnerServices(dd4hep::PlacedVolume& pVol, dd4hep::Volume& ModuleLogicalZMinus,
                                               dd4hep::Volume& ModuleLogicalZPlus);

  bool PlaceHcalInnerServicesLayer(dd4hep::PlacedVolume& pVol, dd4hep::Volume& motherLogical,
  ...
  bool FillHcalElectronicsInterfaceLayer(dd4hep::PlacedVolume& pVol, dd4hep::Volume& ModuleLogicalZMinus,
                                         dd4hep::Volume& ModuleLogicalZPlus, double layer_y_offset, double layer_x_dim);

  bool PlaceHcalElectronicsInterfaceComponent(dd4hep::PlacedVolume& pVol, dd4hep::Volume& ModuleLogicalZMinus,
                                              dd4hep::Volume& ModuleLogicalZPlus, dd4hep::Material layerMaterial,
                                              double layerThickness, double y_position, double layer_x_dim) {

    dd4hep::Box layerBox(layer_x_dim / 2. - 4 * (SurfaceTolerance), layerThickness / 2. - 4 * (SurfaceTolerance),
    ...
    dd4hep::Volume layerLogical("ElectronicsInterfaceLayerLogical", cutSolid, layerMaterial);
  ...
  bool DoBuildHcalBarrel_EndCapServices(dd4hep::PlacedVolume& pVol, dd4hep::Assembly& envelope);
