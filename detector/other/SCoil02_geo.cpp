...
static Ref_t create_element(Detector& theDetector, xml_h element, SensitiveDetector /*sens*/) {
  ...
  Tube CoilMainSolid_1(175 * dd4hep::mm + inner_radius, 560 * dd4hep::mm + inner_radius,
                       1632. * dd4hep::mm / 2 - 0. * dd4hep::mm);
  ...
  Tubs* CoilCorrectSolid_1 Tube("CoilCorrect_1", 175 * dd4hep::mm + inner_radius, 560 * dd4hep::mm + inner_radius,
                                1224. * dd4hep::mm / 2, 0 * deg, 360. * deg);

  Volume* CoilCorrectLogical_1 =
      new Volume(CoilCorrectSolid_1, theDetector.material("aluminium"), "CoilCorrect_1", 0, 0, 0);
  ...
  .setPlacement(0, ThreeVector(0., 0., -1632. * dd4hep::mm * 3 / 2 - 612.), CoilCorrectLogical_1, "CoilCorrect_1",
                WorldLog, false, 0);
  ...
  //... Coil mandrel
  Tubs* CoilMandrelSolid Tube("CoilMandrel", 560 * dd4hep::mm + inner_radius, 635 * dd4hep::mm + inner_radius,
                              3675. * dd4hep::mm, 0 * deg, 360. * deg);

  Volume* CoilMandrelLogical = new Volume(CoilMandrelSolid, theDetector.material("aluminium"), "CoilMandrel", 0, 0, 0);
  ...
  .setPlacement(0, ThreeVector(0., 0., 0.), CoilMandrelLogical, "CoilMandrel", WorldLog, false, 0);
  ...
  theCoilSD = new TRKSD00("COIL", sensitive_thickness * dd4hep::mm * 200 * keV * 0.01);
  RegisterSensitiveDetector(theCoilSD);

  //... Scintillator Detector layer 1

  const double zPozBarrelArray_1[2] = {-100. * dd4hep::mm + half_z, +100. * dd4hep::mm - half_z};
  const double rInnerBarrelArray_1[2] = {90. * dd4hep::mm + inner_radius, 90. * dd4hep::mm + inner_radius};
  const double rOuterBarrelArray_1[2] = {100. * dd4hep::mm + inner_radius, 100. * dd4hep::mm + inner_radius};
  //... Coil detector geometry

  Polyhedra* CoilScintSolid_1 = new Polyhedra("CoilScint_1", 0. * deg, 360. * deg, 24, 2, zPozBarrelArray_1,
                                              rInnerBarrelArray_1, rOuterBarrelArray_1);

  Volume* CoilScintLogical_1 =
      new Volume(CoilScintSolid_1, theDetector.material("polystyrene"), "CoilScint_1", 0, 0, 0);
  ...
  .setPlacement(0, ThreeVector(0., 0., 0.), CoilScintLogical_1, "CoilScint_1", WorldLog, false, layer_id);

  layer_id++;
  //... Scintillation Detector layer 2
  const double zPozBarrelArray_2[2] = {-100. * dd4hep::mm + half_z, +100. * dd4hep::mm - half_z};
  const double rInnerBarrelArray_2[2] = {105. * dd4hep::mm + inner_radius, 105. * dd4hep::mm + inner_radius};
  const double rOuterBarrelArray_2[2] = {115. * dd4hep::mm + inner_radius, 115. * dd4hep::mm + inner_radius};

  Polyhedra* CoilScintSolid_2 = new Polyhedra("CoilScint_2", 0. * deg, 360. * deg, 24, 2, zPozBarrelArray_2,
                                              rInnerBarrelArray_2, rOuterBarrelArray_2);

  Volume* CoilScintLogical_2 =
      new Volume(CoilScintSolid_2, theDetector.material("polystyrene"), "CoilScint_2", 0, 0, 0);
  ...
  .setPlacement(0, ThreeVector(0., 0., 0.), CoilScintLogical_2, "CoilScint_2", WorldLog, false, layer_id);

  layer_id++;
  //... Scint detector layer 3

  const double zPozBarrelArray_3[2] = {-100. * dd4hep::mm + half_z, +100. * dd4hep::mm - half_z};
  const double rInnerBarrelArray_3[2] = {-90. * dd4hep::mm + outer_radius, -90. * dd4hep::mm + outer_radius};
  const double rOuterBarrelArray_3[2] = {-80. * dd4hep::mm + outer_radius, -80. * dd4hep::mm + outer_radius};

  Polyhedra* CoilScintSolid_3 = new Polyhedra("CoilScint_3", 0. * deg, 360. * deg, 24, 2, zPozBarrelArray_3,
                                              rInnerBarrelArray_3, rOuterBarrelArray_3);

  Volume* CoilScintLogical_3 =
      new Volume(CoilScintSolid_3, theDetector.material("polystyrene"), "CoilScint_3", 0, 0, 0);
  ...
  .setPlacement(0, ThreeVector(0., 0., 0.), CoilScintLogical_3, "CoilScint_3", WorldLog, false, layer_id);
  layer_id++;
  //... Scintillation Detector layer 4
  const double zPozBarrelArray_4[2] = {-100. * dd4hep::mm + half_z, +100. * dd4hep::mm - half_z};
  const double rInnerBarrelArray_4[2] = {-105. * dd4hep::mm + outer_radius, -105. * dd4hep::mm + outer_radius};
  const double rOuterBarrelArray_4[2] = {-95. * dd4hep::mm + outer_radius, -95. * dd4hep::mm + outer_radius};

  Polyhedra* CoilScintSolid_4 = new Polyhedra("CoilScint_4", 0. * deg, 360. * deg, 24, 2, zPozBarrelArray_4,
                                              rInnerBarrelArray_4, rOuterBarrelArray_4);

  Volume* CoilScintLogical_4 =
      new Volume(CoilScintSolid_4, theDetector.material("polystyrene"), "CoilScint_4", 0, 0, 0);
  ...
  .setPlacement(0, ThreeVector(0., 0., 0.), CoilScintLogical_4, "CoilScint_4", WorldLog, false, layer_id);
  ...
  // Inner Cylinder
  gp->setDoubleVal("Coil_cryostat_inner_cyl_inner_radius", inner_radius);
  gp->setDoubleVal("Coil_cryostat_inner_cyl_outer_radius", 40. * dd4hep::mm + outer_radius);
  gp->setDoubleVal("Coil_cryostat_inner_cyl_half_z", half_z);
  gp->setStringVal("Coil_material_inner_cyl", "aluminium");

  // Outer Cylinder
  gp->setDoubleVal("Coil_cryostat_outer_cyl_inner_radius", -30 * dd4hep::mm + outer_radius);
  gp->setDoubleVal("Coil_cryostat_outer_cyl_outer_radius", outer_radius);
  ...
  gp->setDoubleVal("Coil_cryostat_side_l_inner_radius", 40 * dd4hep::mm + inner_radius);
  gp->setDoubleVal("Coil_cryostat_side_l_outer_radius", -30 * dd4hep::mm + outer_radius);
  gp->setDoubleVal("Coil_cryostat_side_l_half_z", 25. * dd4hep::mm);
  gp->setStringVal("Coil_material_side_l", "aluminium");

  // Side wall right

  gp->setDoubleVal("Coil_cryostat_side_r_inner_radius", 40 * dd4hep::mm + inner_radius);
  gp->setDoubleVal("Coil_cryostat_side_r_outer_radius", -30 * dd4hep::mm + outer_radius);
  gp->setDoubleVal("Coil_cryostat_side_r_half_z", 25. * dd4hep::mm);
  gp->setStringVal("Coil_material_side_r", "aluminium");

  // Coil modules

  gp->setDoubleVal("Coil_cryostat_modules_inner_radius", 175 * dd4hep::mm + inner_radius);
  gp->setDoubleVal("Coil_cryostat_modules_outer_radius", 560 * dd4hep::mm + inner_radius);
  ...
  gp->setDoubleVal("Coil_cryostat_c_modules_inner_radius", 175 * dd4hep::mm + inner_radius);
  gp->setDoubleVal("Coil_cryostat_c_modules_outer_radius", 560 * dd4hep::mm + inner_radius);
  gp->setDoubleVal("Coil_cryostat_c_modules_half_z", 1224. * dd4hep::mm);
  gp->setStringVal("Coil_material_c_modules", "aluminium");

  // Coil mandrel

  gp->setDoubleVal("Coil_cryostat_mandrel_inner_radius", 560 * dd4hep::mm + inner_radius);
  gp->setDoubleVal("Coil_cryostat_mandrel_outer_radius", 635 * dd4hep::mm + inner_radius);
  gp->setDoubleVal("Coil_cryostat_mandrel_half_z", 3675. * dd4hep::mm);
  gp->setStringVal("Coil_material_mandrel", "aluminium");

  // Sensitive detectors

  gp->setDoubleVal("Coil_cryostat_scint1_inner_radius", 90 * dd4hep::mm + inner_radius);
  gp->setDoubleVal("Coil_cryostat_scint1_outer_radius", 100 * dd4hep::mm + inner_radius);
  gp->setDoubleVal("Coil_cryostat_scint1_zposin", -100 * dd4hep::mm + half_z);
  gp->setDoubleVal("Coil_cryostat_scint1_zposend", +100 * dd4hep::mm + half_z);
  gp->setStringVal("Coil_material_scint1", "polystyrene");

  gp->setDoubleVal("Coil_cryostat_scint2_inner_radius", 105 * dd4hep::mm + inner_radius);
  gp->setDoubleVal("Coil_cryostat_scint2_outer_radius", 115 * dd4hep::mm + inner_radius);
  gp->setDoubleVal("Coil_cryostat_scint2_zposin", -100 * dd4hep::mm + half_z);
  gp->setDoubleVal("Coil_cryostat_scint2_zposend", +100 * dd4hep::mm + half_z);
  gp->setStringVal("Coil_material_scint2", "polystyrene");

  gp->setDoubleVal("Coil_cryostat_scint3_inner_radius", -90 * dd4hep::mm + outer_radius);
  gp->setDoubleVal("Coil_cryostat_scint3_outer_radius", -80 * dd4hep::mm + outer_radius);
  gp->setDoubleVal("Coil_cryostat_scint3_zposin", -100 * dd4hep::mm + half_z);
  gp->setDoubleVal("Coil_cryostat_scint3_zposend", +100 * dd4hep::mm + half_z);
  gp->setStringVal("Coil_material_scint3", "polystyrene");

  gp->setDoubleVal("Coil_cryostat_scint4_inner_radius", -105 * dd4hep::mm + outer_radius);
  gp->setDoubleVal("Coil_cryostat_scint4_outer_radius", -95 * dd4hep::mm + outer_radius);
  gp->setDoubleVal("Coil_cryostat_scint4_zposin", -100 * dd4hep::mm + half_z);
  gp->setDoubleVal("Coil_cryostat_scint4_zposend", +100 * dd4hep::mm + half_z);
  ...
  // VolPlane surf( sitSenLogical , SurfaceType(SurfaceType::Sensitive,SurfaceType::Measurement1D) ,inner_thick,
  // outer_thick , u,v,n ) ; //,o ) ;
