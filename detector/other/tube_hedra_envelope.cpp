...
//--------------------------------------------------------------------
//  DD4hep Geometry circle outer and polyhedra hole inner envelope
//--------------------------------------------------------------------
//  S.Lu, DESY
//  $Id:$
//====================================================================
...
static Ref_t create_detector(LCDD& lcdd, xml_h e, SensitiveDetector /*sens*/)  {
 ...
 //unused:  Material      air       = lcdd.air();
  ...
  //Tube             tube_solid(0, outer_r+tolerance*2e0,x_dim.zhalf());
  Cone             tube_solid(x_dim.zhalf(), 0, outer_r+tolerance*2e0, 0, outer_r+tolerance*2e0);
...
DECLARE_DETELEMENT(tube_hedra_envelope,create_detector)
