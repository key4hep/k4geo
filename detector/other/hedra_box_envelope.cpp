...
//--------------------------------------------------------------------
//  DD4hep Geometry polyhedra outer with box hole inner envelope
//--------------------------------------------------------------------
//  S.Lu, DESY
//  $Id:$
//====================================================================
...
static Ref_t create_detector(LCDD& lcdd, xml_h e, SensitiveDetector /*sens*/)  {
 ...
 //unused:  double        thickness = layering.totalThickness();
  ...
  RotationZYX   rotZYX_box(-env_rot.z(),env_rot.y(),env_rot.x());
 ...
 //unused:  xml_comp_t    x_staves  = x_det.staves();
  ...
  PolyhedraRegular hedra_solid (nsides,0,outer_r+tolerance*2e0,x_dim.zhalf()*2.0);
...
DECLARE_DETELEMENT(hedra_box_envelope,create_detector)
