...
static Ref_t create_detector(Detector& theDetector, xml_h element, SensitiveDetector sens) {
  ...
  cout << "SEcal05_Barrel: absorber layers " << Ecal_nlayers1 << "*" << Ecal_radiator_thickness1 / dd4hep::mm
  ...
  if (fabs(Ecal_barrel_thickness - module_thickness) > 0.01) {
    cout << "ERROR SEcal05_Barrel : ECAL barrel thickness in comapct decription not consistent with what I calculate!"
         << endl;
  ...
  if (min_dim_x < 0 || max_dim_x < 0) {
    std::cout << "SEcal05_Barrel ERROR : requesting too many sides! barrel modules have max/min extent " << max_dim_x
              << " " << min_dim_x << std::endl;
