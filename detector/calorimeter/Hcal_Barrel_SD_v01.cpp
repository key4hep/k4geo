//====================================================================
//  DD4hep Geometry driver for semi digital HcalBarrel
//  based on SHcalSC04_Barrel_v01 by S.Lu, DESY
//--------------------------------------------------------------------
//  G.Grenier
//  $Id:  $
//====================================================================
...
bool validateEnvelope_Hcal_Barrel_SD_v01(double rInner, double rOuter, double radiatorThickness, double layerThickness, int layerNumber){
  ...
  if( spaceNeeded > spaceAllowed )
    ...
    {
      cout<<"\n Hcal_Barrel_SD_v01 has been validated and start to build it." <<endl;
      Error = false;
      Warning = false;
    }
...
//====================================================================
  ...
  validateEnvelope_Hcal_Barrel_SD_v01(Hcal_inner_radius, Hcal_outer_radius, Hcal_radiator_thickness, Hcal_chamber_thickness, Hcal_nlayers);
