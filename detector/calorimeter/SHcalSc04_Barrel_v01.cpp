...
//--------------------------------------------------------------------
//  S.Lu, DESY
//  $Id: SHcalSc04_Barrel.cpp 305 2015-03-13 16:13:11Z gaede $
//====================================================================

 /* History:  
    
   F.Gaede: 03/2015: SHcalSc04_Barrel_v01:
                     remove envelope volume - to be used with an externally contructed envelope volume
                     -> experimental
...
bool validate_v01(double rInner, double rOuter, double radiatorThickness, double layerThickness, int layerNumber){
...
//====================================================================
  ...
  validate_v01(Hcal_inner_radius, Hcal_outer_radius, Hcal_radiator_thickness, Hcal_chamber_thickness, Hcal_nlayers);
