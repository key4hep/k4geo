...
//====================================================================
 ...
 /* History:  
   ...
   F.Gaede: 03/2015: SHcalSc04_Barrel_v02:
                     create envelope volume with create_envelope() using the xml 
                     -> experimental
...
bool validate_v02(double rInner, double rOuter, double radiatorThickness, double layerThickness, int layerNumber){
...
//====================================================================
  ...
  validate_v02(Hcal_inner_radius, Hcal_outer_radius, Hcal_radiator_thickness, Hcal_chamber_thickness, Hcal_nlayers);
