...
//====================================================================
  ...
  int         Hcal_stair_ntiles                = lcdd.constant<int>("Hcal_stair_ntiles");
...
// ==========================================================================
  ...
  EnvLogHcalModule1Barrel.setAttributes(lcdd,x_det.regionStr(),x_det.limitsStr(),x_det.visStr());
  EnvLogHcalModule2Barrel.setAttributes(lcdd,x_det.regionStr(),x_det.limitsStr(),x_det.visStr());
  ...
  EnvLogHcalModuleBarrelTop_LP.setAttributes(lcdd,x_det.regionStr(), x_det.limitsStr(), x_det.visStr());
  EnvLogHcalModuleBarrelMiddle_LP.setAttributes(lcdd,x_det.regionStr(), x_det.limitsStr(), x_det.visStr());
  EnvLogHcalModuleBarrelBottom_LP.setAttributes(lcdd,x_det.regionStr(), x_det.limitsStr(), x_det.visStr());
...
//====================================================================
	...
	m1_slice_vol.setAttributes(lcdd,x_slice.regionStr(),x_slice.limitsStr(),x_slice.visStr());
	m2_slice_vol.setAttributes(lcdd,x_slice.regionStr(),x_slice.limitsStr(),x_slice.visStr());
	// slice PlacedVolume
