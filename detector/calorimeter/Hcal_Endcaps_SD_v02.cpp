...
static Ref_t create_detector(Detector& theDetector, xml_h element, SensitiveDetector sens) {
  ...
  double SpaceForLayers = HcalEndcap_max_z - HcalEndcap_min_z - Hcal_back_plate_thickness;
  ...
  cout << "    Possible/ Requested #of chambers= " << possible_number_of_chambers << " / " << HcalEndcap_nlayers
       << endl;
  ...
  for (xml_coll_t c(x_det.child(_U(dimensions)), _U(dimensions)); c; ++c) {
    ...
    cout << "Hcal_Endcaps: towerID, dim_x, dim_y, dim_z = " << towerID << " " << dim_x << " " << dim_y << " " << dim_z
         << endl;
    ...
    for (int stave_num = 0; stave_num < 4; stave_num++) {
      ...
      for (int module_num = 0; module_num < 2; module_num++) {
        ...
        //          cout << " Hcal_Endcaps: module_id = " << module_id << " rot_EM= "<<rot_EM  << " rot_EMZ= "<<rot_EMZ
        //          <<endl;
        EndcapModule_pos_z = (module_id == 0) ? -EndcapModule_center_pos_z : EndcapModule_center_pos_z;
        cout << " Hcal_Endcaps: module,towerID,staveID, module_pos_x,y,z = " << module_id << " " << towerID << " "
             << stave_num << " " << EndcapModule_pos_x << " " << EndcapModule_pos_y << " " << EndcapModule_pos_z
             << endl;
