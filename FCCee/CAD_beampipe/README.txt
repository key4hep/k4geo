...
Model up to -6m/+6m from the IP.
Remote vacuum connection not already designed, for now a sharp transition between AlBeMet and Copper beam pipe at 1.2m from IP
