...
# Whole IDEA
detector="FCCee_IDEA_o1_v01.xml"
...
# 2D eta
k4run scripts/utils/material_scan_2D.py --GeoSvc.detector ${detector} --GeoDump.filename ${outputFolder}_scan_2D_eta.root --GeoDump.angleDef eta --GeoDump.angleBinning ${etaBinning} --GeoDump.angleMin -3.0 --GeoDump.angleMax 3.0 --GeoDump.nPhi ${nPhiBins} 

# 2D theta
k4run scripts/utils/material_scan_2D.py --GeoSvc.detector ${detector} --GeoDump.filename ${outputFolder}_scan_2D_theta.root --GeoDump.angleDef theta --GeoDump.angleBinning ${thetaBinning} --GeoDump.angleMin 0.0 --GeoDump.angleMax $thetaMax --GeoDump.nPhi ${nPhiBins} 

# 2D cosTheta
k4run scripts/utils/material_scan_2D.py --GeoSvc.detector ${detector} --GeoDump.filename ${outputFolder}_scan_2D_cosTheta.root --GeoDump.angleDef cosTheta --GeoDump.angleBinning ${cosThetaBinning} --GeoDump.angleMin $cosThetaMin --GeoDump.angleMax 1.0 --GeoDump.nPhi ${nPhiBins} 

# 1D cosTheta
k4run scripts/utils/material_scan.py --GeoSvc.detector ${detector} --GeoDump.filename ${outputFolder}_scan_1D_cosTheta.root --GeoDump.angleDef cosTheta --GeoDump.angleBinning ${cosThetaBinning} --GeoDump.angleMin $cosThetaMin --GeoDump.angleMax 1.0 --GeoDump.nPhiTrials 100

# 1D eta
k4run scripts/utils/material_scan.py --GeoSvc.detector ${detector} --GeoDump.filename ${outputFolder}_scan_1D_eta.root --GeoDump.angleDef eta --GeoDump.angleBinning ${etaBinning} --GeoDump.angleMin -3.0 --GeoDump.angleMax 3.0 --GeoDump.nPhiTrials 100

# 1D theta
k4run scripts/utils/material_scan.py --GeoSvc.detector ${detector} --GeoDump.filename ${outputFolder}_scan_1D_theta.root --GeoDump.angleDef theta --GeoDump.angleBinning ${thetaBinning} --GeoDump.angleMin 0.0 --GeoDump.angleMax $thetaMax --GeoDump.nPhiTrials 100
