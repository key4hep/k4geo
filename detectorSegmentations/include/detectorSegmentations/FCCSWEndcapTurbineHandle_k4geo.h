#ifndef DD4HEP_DDCORE_ENDCAPTURBINE_H
#define DD4HEP_DDCORE_ENDCAPTURBINE_H 1
...
typedef Handle<SegmentationWrapper<DDSegmentation::FCCSWEndcapTurbine_k4geo>> FCCSWEndcapTurbineHandle_k4geo;
 ...
 *
 */
class FCCSWEndcapTurbine_k4geo : public FCCSWEndcapTurbineHandle_k4geo {
public:
  /// Defintiion of the basic handled object
  typedef FCCSWEndcapTurbineHandle_k4geo::Object Object;

public:
  /// Default constructor
  FCCSWEndcapTurbine_k4geo() = default;
  /// Copy constructor
  FCCSWEndcapTurbine_k4geo(const FCCSWEndcapTurbine_k4geo& e) = default;
  /// Copy Constructor from segmentation base object
  FCCSWEndcapTurbine_k4geo(const Segmentation& e) : Handle<Object>(e) {}
  /// Copy constructor from handle
  FCCSWEndcapTurbine_k4geo(const Handle<Object>& e) : Handle<Object>(e) {}
  /// Copy constructor from other polymorph/equivalent handle
  template <typename Q>
  FCCSWEndcapTurbine_k4geo(const Handle<Q>& e) : Handle<Object>(e) {}
  /// Assignment operator
  FCCSWEndcapTurbine_k4geo& operator=(const FCCSWEndcapTurbine_k4geo& seg) = default;
  /// Equality operator
  bool operator==(const FCCSWEndcapTurbine_k4geo& seg) const { return m_element == seg.m_element; }
...
#endif  // DD4HEP_DDCORE_ENDCAPTURBINE_H
