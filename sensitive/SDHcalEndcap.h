...
/** @class SDHcalEndcap SDHcalEndcap.hh "SDHcalEndcap.hh" 
...
namespace lcgeo {
  ...
  /** Sensitive detector for ILD HcalBarrel - ported from Mokka SDHcalEndcap 
  ...
  public:
    ...
    SDHcalEndcap(dd4hep::Geant4Context* context, const std::string& name, DetElement det, LCDD& lcdd)
