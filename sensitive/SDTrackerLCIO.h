...
//  17.07.2014
//====================================================================
#ifndef SDTrackerLCIO_h
#define SDTrackerLCIO_h 1
...
namespace DDSim {
  ...
  public:
    ...
    SDTrackerLCIO(dd4hep::Geant4Context* mContext, const std::string& mName, DetElement mDet, LCDD& mLcdd):
