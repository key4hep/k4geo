...
namespace dd4hep
{
  ...
  namespace sim
  {
    ...
    struct DRCData {
      ...
      double fGraph_X[fArraySize] = { 1.37760 * CLHEP::eV,
                                      1.45864 * CLHEP::eV,
                                      1.54980 * CLHEP::eV,
                                      1.65312 * CLHEP::eV,
                                      1.71013 * CLHEP::eV,
      ...
      double fGraph_Y[fArraySize] = { 0.903,
                                      0.903,
                                      0.903,
                                      0.903,
                                      0.903,
      ...
      double getFilterEff(G4double G4energy) {
        ...
        if (G4energy <= fGraph_X[0])
          return fGraph_Y[0];

        for(int idx = 1; idx < fArraySize; ++idx) {
          if (G4energy <= fGraph_X[idx]) {
    ...
    : Geant4Sensitive(ctxt,nam,det,desc), m_collectionName(), m_collectionID(0)
    {
      ...
      m_userData.fastfiber.fSafety = 0.;
