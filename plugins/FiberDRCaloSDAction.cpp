...
namespace dd4hep {
    ...
    */
        ...
        template <> void Geant4SensitiveAction<DRCData>::defineCollections() {
        ...
        template <> G4bool Geant4SensitiveAction<DRCData>::process(G4Step GEANT4_CONST_STEP * step, G4TouchableHistory* history) {
